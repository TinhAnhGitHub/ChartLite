...
# from .adapter import inject_adapters, AdapterPlus
# from transformers import Pix2StructConfig, Pix2StructForConditionalGeneration

# class Matcha(nn.Module):
#     """
#     The Matcha model using AdapterHub
#     """
...
#         if cfg.model.adapter_type == "adapterplus":
#             inject_adapters(self.backbone.encoder.encoder.layer, AdapterPlus)
